...
import './mobiledisplayofalcoholicdetailspage.css';
...
const Mobiledisplayofalcoholicdetailspage = () => {
...
}) => ({ _id, productName,productPrice, shopName,catSelected,subCatItemSelected,shopPhone,shopAddress,productImage,productDescription })).filter(item => item.catSelected === 'Drinks(Alcoholic)');
...
export default Mobiledisplayofalcoholicdetailspage;
