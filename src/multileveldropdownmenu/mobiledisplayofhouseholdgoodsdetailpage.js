...
import './mobiledisplayofhouseholdgoodsdetailpage.css';
...
const Mobiledisplayofhouseholdgoodsdetailspage = () => {
...
}) => ({ _id, productName,productPrice, shopName,catSelected,subCatItemSelected,shopPhone,shopAddress,productImage,productDescription })).filter(item => item.catSelected === 'Household Goods');
...
export default Mobiledisplayofhouseholdgoodsdetailspage;
