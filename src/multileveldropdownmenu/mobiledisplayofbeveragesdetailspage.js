...
const Mobiledisplayofbeveragesdetailspage = () => {
...
}) => ({ _id, productName,productPrice, shopName,catSelected,subCatItemSelected,shopPhone,shopAddress,productImage,productDescription })).filter(item => item.catSelected === 'Beverages');
...
export default Mobiledisplayofbeveragesdetailspage;
